...
$(function() {
    var i = {
        Started: {
            scrolllRun: function(e) {
                ...
                if (0 < o.length)
                    if (jQuery.browser.mobile)
                        o.scrollTop(o.get(0).scrollHeight, -1);
                    else {
                        var i = {
                        ...
                        $(".files ul").niceScroll(i),
                        o.scrollTop(o.get(0).scrollHeight, -1).niceScroll(i),
                        $(".layout .content .sidebar .sidebar-body").niceScroll(i),
                        e && ($(".files ul").getNiceScroll().resize(),
                        o.scrollTop(o.get(0).scrollHeight, -1).getNiceScroll().resize(),
            ...
            init: function() {
                ...
                jQuery.browser.mobile && ($("body").addClass("no-blur-effect"),
    ...
    $(document).on("click", "[data-navigation-target]", function() {
        ...
        jQuery.browser.mobile && ($(".sidebar-group").removeClass("mobile-open"),
        o.closest(".sidebar-group").addClass("mobile-open")),
        i.Started.scrolllRun(!0)
    }),
    $(document).on("click", ".sidebar-close", function(e) {
        jQuery.browser.mobile ? $(".sidebar-group").removeClass("mobile-open") : $(this).closest(".sidebar.active").removeClass("active"),
        i.Started.scrolllRun(!0)
    }),
