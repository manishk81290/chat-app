...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      directives: [_components_loader_loader_component__WEBPACK_IMPORTED_MODULE_1__["LoaderComponent"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterOutlet"]],
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var toppy__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! toppy */
    "./node_modules/toppy/__ivy_ngcc__/fesm2015/toppy.js");
    /* harmony import */


    var angular2_draggable__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! angular2-draggable */
    ...
    var _components_side_menu_side_menu_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./components/side-menu/side-menu.component */
    "./src/app/components/side-menu/side-menu.component.ts");
    /* harmony import */


    var _components_chat_menu_chat_menu_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ./components/chat-menu/chat-menu.component */
    "./src/app/components/chat-menu/chat-menu.component.ts");
    /* harmony import */


    var _components_chat_window_chat_window_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ./components/chat-window/chat-window.component */
    "./src/app/components/chat-window/chat-window.component.ts");
    /* harmony import */


    var _components_user_info_user_info_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ./components/user-info/user-info.component */
    "./src/app/components/user-info/user-info.component.ts");
    /* harmony import */


    var _components_models_disconnected_model_disconnected_model_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    /*! ./components/models/disconnected-model/disconnected-model.component */
    "./src/app/components/models/disconnected-model/disconnected-model.component.ts");
    /* harmony import */


    var _components_models_call_model_call_model_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! ./components/models/call-model/call-model.component */
    "./src/app/components/models/call-model/call-model.component.ts");
    /* harmony import */


    var _components_models_settings_model_settings_model_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
    /*! ./components/models/settings-model/settings-model.component */
    "./src/app/components/models/settings-model/settings-model.component.ts");
    /* harmony import */


    var _components_models_edit_profile_model_edit_profile_model_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
    /*! ./components/models/edit-profile-model/edit-profile-model.component */
    "./src/app/components/models/edit-profile-model/edit-profile-model.component.ts");
    /* harmony import */


    var _components_models_add_friend_model_add_friend_model_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
    /*! ./components/models/add-friend-model/add-friend-model.component */
    "./src/app/components/models/add-friend-model/add-friend-model.component.ts");
    /* harmony import */


    var _components_models_new_group_model_new_group_model_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
    /*! ./components/models/new-group-model/new-group-model.component */
    "./src/app/components/models/new-group-model/new-group-model.component.ts");
    /* harmony import */


    var _components_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
    /*! ./components/dashboard/dashboard.component */
    "./src/app/components/dashboard/dashboard.component.ts");
    /* harmony import */
    ...
    var _components_register_register_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
    /*! ./components/register/register.component */
    "./src/app/components/register/register.component.ts");
    /* harmony import */
    ...
    var ngx_file_helpers__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(
    /*! ngx-file-helpers */
    "./node_modules/ngx-file-helpers/__ivy_ngcc__/fesm2015/ngx-file-helpers.js");
    /* harmony import */


    var ngx_cookie_service__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(
    /*! ngx-cookie-service */
    "./node_modules/ngx-cookie-service/__ivy_ngcc__/ngx-cookie-service.js");
    /* harmony import */


    var _components_chat_menu_user_list_item_user_list_item_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(
    /*! ./components/chat-menu/user-list-item/user-list-item.component */
    "./src/app/components/chat-menu/user-list-item/user-list-item.component.ts");
    /* harmony import */


    var _components_chat_menu_user_list_user_list_component__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(
    /*! ./components/chat-menu/user-list/user-list.component */
    "./src/app/components/chat-menu/user-list/user-list.component.ts");
    /* harmony import */


    var _components_chat_window_message_list_message_list_component__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(
    /*! ./components/chat-window/message-list/message-list.component */
    "./src/app/components/chat-window/message-list/message-list.component.ts");
    /* harmony import */


    var _components_chat_window_message_list_message_message_component__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(
    /*! ./components/chat-window/message-list/message/message.component */
    "./src/app/components/chat-window/message-list/message/message.component.ts");
    /* harmony import */


    var src_environments_environment__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(
    /*! src/environments/environment */
    "./src/environments/environment.ts");
    /* harmony import */


    var _components_loader_loader_component__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(
    /*! ./components/loader/loader.component */
    "./src/app/components/loader/loader.component.ts");
    /* harmony import */


    var _ctrl_ngx_emoji_mart__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(
    /*! @ctrl/ngx-emoji-mart */
    "./node_modules/@ctrl/ngx-emoji-mart/__ivy_ngcc__/fesm2015/ctrl-ngx-emoji-mart.js");
    /* harmony import */


    var _components_profile_panel_profile_panel_component__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(
    /*! ./components/profile-panel/profile-panel.component */
    "./src/app/components/profile-panel/profile-panel.component.ts");
    /* harmony import */


    var _pipes_time_ago_pipe__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(
    /*! ./pipes/time-ago.pipe */
    "./src/app/pipes/time-ago.pipe.ts");
    /* harmony import */


    var _pipes_filter_pipe__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(
    /*! ./pipes/filter.pipe */
    "./src/app/pipes/filter.pipe.ts");
    /* harmony import */


    var _components_user_profile_image_user_profile_image_component__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(
    /*! ./components/user-profile-image/user-profile-image.component */
    "./src/app/components/user-profile-image/user-profile-image.component.ts");
    /* harmony import */


    var _components_right_panel_right_panel_component__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(
    /*! ./components/right-panel/right-panel.component */
    "./src/app/components/right-panel/right-panel.component.ts");
    /* harmony import */


    var _components_incoming_call_incoming_call_component__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(
    /*! ./components/incoming-call/incoming-call.component */
    "./src/app/components/incoming-call/incoming-call.component.ts");
    /* harmony import */


    var _components_min_call_window_min_call_window_component__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(
    /*! ./components/min-call-window/min-call-window.component */
    "./src/app/components/min-call-window/min-call-window.component.ts");
    /* harmony import */


    var _components_max_video_call_max_video_call_component__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(
    /*! ./components/max-video-call/max-video-call.component */
    "./src/app/components/max-video-call/max-video-call.component.ts");
    /* harmony import */


    var _pipes_message_pipe__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(
    /*! ./pipes/message.pipe */
    "./src/app/pipes/message.pipe.ts");

    var config = {
      url: src_environments_environment__WEBPACK_IMPORTED_MODULE_28__["environment"].SERVER_URL,
      options: {}
    };
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClientModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_6__["AppRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_21__["FormsModule"], _ctrl_ngx_emoji_mart__WEBPACK_IMPORTED_MODULE_30__["PickerModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_21__["ReactiveFormsModule"], ngx_socket_io__WEBPACK_IMPORTED_MODULE_2__["SocketIoModule"].forRoot(config), toppy__WEBPACK_IMPORTED_MODULE_3__["ToppyModule"], ngx_file_helpers__WEBPACK_IMPORTED_MODULE_22__["NgxFileHelpersModule"], angular2_draggable__WEBPACK_IMPORTED_MODULE_4__["AngularDraggableModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_7__["AppComponent"], _components_side_menu_side_menu_component__WEBPACK_IMPORTED_MODULE_8__["SideMenuComponent"], _components_chat_menu_chat_menu_component__WEBPACK_IMPORTED_MODULE_9__["ChatMenuComponent"], _components_chat_window_chat_window_component__WEBPACK_IMPORTED_MODULE_10__["ChatWindowComponent"], _components_user_info_user_info_component__WEBPACK_IMPORTED_MODULE_11__["UserInfoComponent"], _components_models_disconnected_model_disconnected_model_component__WEBPACK_IMPORTED_MODULE_12__["DisconnectedModelComponent"], _components_models_call_model_call_model_component__WEBPACK_IMPORTED_MODULE_13__["CallModelComponent"], _components_models_settings_model_settings_model_component__WEBPACK_IMPORTED_MODULE_14__["SettingsModelComponent"], _components_models_edit_profile_model_edit_profile_model_component__WEBPACK_IMPORTED_MODULE_15__["EditProfileModelComponent"], _components_models_add_friend_model_add_friend_model_component__WEBPACK_IMPORTED_MODULE_16__["AddFriendModelComponent"], _components_models_new_group_model_new_group_model_component__WEBPACK_IMPORTED_MODULE_17__["NewGroupModelComponent"], _components_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_18__["DashboardComponent"], _components_login_login_component__WEBPACK_IMPORTED_MODULE_19__["LoginComponent"], _components_register_register_component__WEBPACK_IMPORTED_MODULE_20__["RegisterComponent"], _components_chat_menu_user_list_item_user_list_item_component__WEBPACK_IMPORTED_MODULE_24__["UserListItemComponent"], _components_chat_menu_user_list_user_list_component__WEBPACK_IMPORTED_MODULE_25__["UserListComponent"], _components_chat_window_message_list_message_list_component__WEBPACK_IMPORTED_MODULE_26__["MessageListComponent"], _components_chat_window_message_list_message_message_component__WEBPACK_IMPORTED_MODULE_27__["MessageComponent"], _components_loader_loader_component__WEBPACK_IMPORTED_MODULE_29__["LoaderComponent"], _components_profile_panel_profile_panel_component__WEBPACK_IMPORTED_MODULE_31__["ProfilePanelComponent"], _pipes_time_ago_pipe__WEBPACK_IMPORTED_MODULE_32__["TimeAgoPipe"], _pipes_filter_pipe__WEBPACK_IMPORTED_MODULE_33__["FilterPipe"], _components_user_profile_image_user_profile_image_component__WEBPACK_IMPORTED_MODULE_34__["UserProfileImageComponent"], _components_right_panel_right_panel_component__WEBPACK_IMPORTED_MODULE_35__["RightPanelComponent"], _components_incoming_call_incoming_call_component__WEBPACK_IMPORTED_MODULE_36__["IncomingCallComponent"], _components_min_call_window_min_call_window_component__WEBPACK_IMPORTED_MODULE_37__["MinCallWindowComponent"], _components_max_video_call_max_video_call_component__WEBPACK_IMPORTED_MODULE_38__["MaxVideoCallComponent"], _pipes_message_pipe__WEBPACK_IMPORTED_MODULE_39__["MessagePipe"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClientModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_6__["AppRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_21__["FormsModule"], _ctrl_ngx_emoji_mart__WEBPACK_IMPORTED_MODULE_30__["PickerModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_21__["ReactiveFormsModule"], ngx_socket_io__WEBPACK_IMPORTED_MODULE_2__["SocketIoModule"], toppy__WEBPACK_IMPORTED_MODULE_3__["ToppyModule"], ngx_file_helpers__WEBPACK_IMPORTED_MODULE_22__["NgxFileHelpersModule"], angular2_draggable__WEBPACK_IMPORTED_MODULE_4__["AngularDraggableModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  /***/
  function srcAppComponentsChatMenuChatMenuComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ChatMenuComponent", function () {
    ...
    var _c0 = ["app-chat-menu", ""];

    var ChatMenuComponent = /*#__PURE__*/function () {
      function ChatMenuComponent(userService, chatService) {
        _classCallCheck(this, ChatMenuComponent);
      ...
      _createClass(ChatMenuComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this = this;

          this.userService.activeUsers.subscribe(function (data) {
            if (data && data.length) {
              _this.users = data;
              if (_this.users[_this.index]) _this.updateActiveUser(_this.index);
            }
          });
        }
      }, {
        key: "updateActiveUser",
        value: function updateActiveUser(index) {
    ...
    ChatMenuComponent.ɵfac = function ChatMenuComponent_Factory(t) {
      return new (t || ChatMenuComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_user_service__WEBPACK_IMPORTED_MODULE_1__["UserService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_chat_service__WEBPACK_IMPORTED_MODULE_2__["ChatService"]));
    };

    ChatMenuComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: ChatMenuComponent,
      selectors: [["", "app-chat-menu", ""]],
      attrs: _c0,
      decls: 27,
      vars: 5,
      consts: [[1, "col-lg-3", "col-md-3", "col-xs-12", "msg-list"], [1, "col-md-12", "search-bar-container"], ["type", "text", "placeholder", "Search user", 1, "searchbox", 3, "ngModel", "ngModelChange"], [1, "col-md-12", "sorting"], [1, "btn-group"], [1, ""], ["type", "button", "data-toggle", "dropdown", "aria-haspopup", "true", "aria-expanded", "false", 1, "btn", "dropdown-toggle", "sort-dropdown"], [1, "caret"], [1, "dropdown-menu"], ["href", "#"], ["role", "separator", 1, "divider"], [3, "users", "updateUser"]],
      template: function ChatMenuComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function ChatMenuComponent_Template_input_ngModelChange_2_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("updateUser", function ChatMenuComponent_Template_app_user_list_updateUser_25_listener($event) {
            return ctx.updateActiveUser($event);
          });
      ...
      directives: [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["DefaultValueAccessor"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["NgControlStatus"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["NgModel"], _user_list_user_list_component__WEBPACK_IMPORTED_MODULE_4__["UserListComponent"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ChatMenuComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppComponentsChatMenuUserListItemUserListItemComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_app_models_message__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    ...
    var _c0 = ["app-user-list-item", ""];

    function UserListItemComponent_ng_container_0_p_7_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function UserListItemComponent_ng_container_0_span_8_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function UserListItemComponent_ng_container_0_span_9_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function UserListItemComponent_ng_container_0_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var UserListItemComponent = /*#__PURE__*/function () {
      function UserListItemComponent(userService) {
      ...
      _createClass(UserListItemComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          if (this.user.lastMessage && (this.user.lastMessage.messageType === src_app_models_message__WEBPACK_IMPORTED_MODULE_2__["MessageType"].Image || this.user.lastMessage.messageType === src_app_models_message__WEBPACK_IMPORTED_MODULE_2__["MessageType"].Video || this.user.lastMessage.messageType === src_app_models_message__WEBPACK_IMPORTED_MODULE_2__["MessageType"].File)) {
    ...
    UserListItemComponent.ɵfac = function UserListItemComponent_Factory(t) {
      return new (t || UserListItemComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_user_service__WEBPACK_IMPORTED_MODULE_1__["UserService"]));
    };

    UserListItemComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: UserListItemComponent,
      selectors: [["", "app-user-list-item", ""]],
      inputs: {
        user: "user"
      },
      attrs: _c0,
      decls: 1,
      vars: 1,
      consts: [[4, "ngIf"], [1, "col-md-3", "col-xs-4", "user-img"], [3, "src"], [1, "friends-status", 3, "ngClass"], [1, "col-md-9", "col-xs-8", "friend-details"], [1, "friend-name"], ["class", "friend-msg", 4, "ngIf"], ["class", "msg-time", 4, "ngIf"], ["class", "unread-tag", 4, "ngIf"], [1, "friend-msg"], [1, "msg-time"], [1, "unread-tag"]],
      template: function UserListItemComponent_Template(rf, ctx) {
        if (rf & 1) {
      ...
      pipes: [_pipes_time_ago_pipe__WEBPACK_IMPORTED_MODULE_4__["TimeAgoPipe"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](UserListItemComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppComponentsChatMenuUserListUserListComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _user_list_item_user_list_item_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    ...
    function UserListComponent_div_1_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function UserListComponent_div_1_Template_div_click_0_listener() {
          ...
          return ctx_r61.updateActiveUser(i_r60);
        });
    ...
    UserListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 2,
      vars: 1,
      consts: [[1, "col-md-12", "col-xs-12", "msg-items"], ["class", "col-md-12 col-xs-12 msg-card", "app-user-list-item", "", 3, "ngClass", "user", "click", 4, "ngFor", "ngForOf"], ["app-user-list-item", "", 1, "col-md-12", "col-xs-12", "msg-card", 3, "ngClass", "user", "click"]],
      ...
      directives: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["NgForOf"], _user_list_item_user_list_item_component__WEBPACK_IMPORTED_MODULE_2__["UserListItemComponent"], _angular_common__WEBPACK_IMPORTED_MODULE_1__["NgClass"]],
  ...
  function srcAppComponentsChatWindowChatWindowComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ngx_file_helpers__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ngx-file-helpers */
    "./node_modules/ngx-file-helpers/__ivy_ngcc__/fesm2015/ngx-file-helpers.js");
    /* harmony import */


    var src_app_services_call_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! src/app/services/call.service */
    ...
    var _message_list_message_list_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    ...
    var _ctrl_ngx_emoji_mart__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! @ctrl/ngx-emoji-mart */
    "./node_modules/@ctrl/ngx-emoji-mart/__ivy_ngcc__/fesm2015/ctrl-ngx-emoji-mart.js");
    /* harmony import */


    var _pipes_message_pipe__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ../../pipes/message.pipe */
    "./src/app/pipes/message.pipe.ts");

    var _c0 = ["filePicker"];
    var _c1 = ["app-chat-window", ""];
    ...
    function ChatWindowComponent_div_1_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ChatWindowComponent_div_1_Template_a_click_25_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r17);

          var ctx_r16 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r16.toggleCall();
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ChatWindowComponent_div_1_Template_a_click_27_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r17);

          var ctx_r18 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r18.viewProfile();
        });
    ...
    function ChatWindowComponent_emoji_mart_5_Template(rf, ctx) {
      if (rf & 1) {
        var _r20 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "emoji-mart", 45);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("emojiSelect", function ChatWindowComponent_emoji_mart_5_Template_emoji_mart_emojiSelect_0_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r20);

          var ctx_r19 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r19.addEmoji($event);
        });
    ...
    var ChatWindowComponent = /*#__PURE__*/function () {
      function ChatWindowComponent(chatService, userService, callService, cdr) {
        var _this2 = this;
        ...
        this.query = "";
        this.chatMessages = [];
        this.chatService.activeUserSubject.subscribe(function (user) {
          _this2.activeUser = user;

          _this2.resetHeight();
        });
        this.chatService.activeMessages.subscribe(function (messages) {
          if (!messages) messages = [];
          _this2.chatMessages = _toConsumableArray(messages);
          window["scrollToBottom"]();

          _this2.resetHeight();
        });
        this.chatService.searchSubject.subscribe(function (q) {
          _this2.query = q;
        });
        this.resetHeight();
      ...
      _createClass(ChatWindowComponent, [{
        ...
        value: function addEmoji(event) {
          this.messageText = "".concat(this.messageText).concat(event.emoji["native"]);
          this.showEmojiPicker = false;
          window["$"]("#message-input").focus();
        }
      }, {
        key: "toggleCall",
        value: function toggleCall() {
          this.call(); //this.ongoingCall = !this.ongoingCall;

          this.resetHeight();
        }
      }, {
        key: "ignoreTooBigFile",
        value: function ignoreTooBigFile(file) {
        ...
        value: function sendMessage() {
          if (this.messageText.length) {
            var type = this.chatService.isValidUrl(this.messageText) ? src_app_models_message__WEBPACK_IMPORTED_MODULE_2__["MessageType"].Url : src_app_models_message__WEBPACK_IMPORTED_MODULE_2__["MessageType"].Text;
        ...
        key: "onReadStart",
        value: function onReadStart(fileCount) {//file reading
        }
      }, {
        key: "onFilePicked",
        value: function onFilePicked(file) {
          this.picked = file;
        }
      }, {
        key: "resetHeight",
        value: function resetHeight() {
          setTimeout(function () {
            ...
            if ($(".audio-call").outerHeight()) {
              $(".msg-container").height(window.screen.height - $(".audio-call").outerHeight() - $(".msg-chat-header").outerHeight() - $(".msgbox-container").outerHeight() - 125);
            } else {
              $(".msg-container").height(window.screen.height - $(".msg-chat-header").outerHeight() - $(".msgbox-container").outerHeight() - 125);
            }
        ...
        key: "onReadEnd",
        value: function onReadEnd(fileCount) {
          var _this3 = this;

          try {
            var messageType = src_app_models_message__WEBPACK_IMPORTED_MODULE_2__["MessageType"].File;
            var content = this.picked.content;
            ...
            this.chatService.uploadFile(this.picked.underlyingFile).subscribe(function (res) {
              _this3.chatService.sendMessage(res.path, messageType);
            });
    ...
    ChatWindowComponent.ɵfac = function ChatWindowComponent_Factory(t) {
      return new (t || ChatWindowComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_chat_service__WEBPACK_IMPORTED_MODULE_1__["ChatService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_user_service__WEBPACK_IMPORTED_MODULE_3__["UserService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_call_service__WEBPACK_IMPORTED_MODULE_5__["CallService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["ChangeDetectorRef"]));
    };
    ...
    ChatWindowComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function ChatWindowComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("submit", function ChatWindowComponent_Template_form_submit_7_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function ChatWindowComponent_Template_input_ngModelChange_9_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("readStart", function ChatWindowComponent_Template_a_readStart_12_listener($event) {
            return ctx.onReadStart($event);
          })("filePick", function ChatWindowComponent_Template_a_filePick_12_listener($event) {
            return ctx.onFilePicked($event);
          })("readEnd", function ChatWindowComponent_Template_a_readEnd_12_listener($event) {
            return ctx.onReadEnd($event);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ChatWindowComponent_Template_a_click_15_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ChatWindowComponent_Template_a_click_17_listener() {
            return ctx.sendMessage();
          });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ChatWindowComponent, [{
        ...
        return [{
          ...
          type: src_app_services_call_service__WEBPACK_IMPORTED_MODULE_5__["CallService"]
        }, {
  ...
  /***/
  function srcAppComponentsChatWindowMessageListMessageListComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function MessageListComponent_div_0_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "div", 1);
      }

      if (rf & 2) {
        var message_r64 = ctx.$implicit;
    ...
    var MessageListComponent = /*#__PURE__*/function () {
      function MessageListComponent(chatService, userService) {
        var _this4 = this;
    ...
    MessageListComponent.ɵfac = function MessageListComponent_Factory(t) {
      return new (t || MessageListComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_chat_service__WEBPACK_IMPORTED_MODULE_1__["ChatService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_user_service__WEBPACK_IMPORTED_MODULE_2__["UserService"]));
    };

    MessageListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 1,
      vars: 1,
      consts: [["class", "col-md-12 col-xs-12 msg", "app-message", "", 3, "ngClass", "message", "activeUser", "user", "isReceived", 4, "ngFor", "ngForOf"], ["app-message", "", 1, "col-md-12", "col-xs-12", "msg", 3, "ngClass", "message", "activeUser", "user", "isReceived"]],
      ...
      directives: [_angular_common__WEBPACK_IMPORTED_MODULE_3__["NgForOf"], _message_message_component__WEBPACK_IMPORTED_MODULE_4__["MessageComponent"], _angular_common__WEBPACK_IMPORTED_MODULE_3__["NgClass"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](MessageListComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppComponentsChatWindowMessageListMessageMessageComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_app_models_message__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! src/app/models/message */
    "./src/app/models/message.ts");
    /* harmony import */
    ...
    var _pipes_time_ago_pipe__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../../../../pipes/time-ago.pipe */
    "./src/app/pipes/time-ago.pipe.ts");
    ...
    function MessageComponent_p_6_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function MessageComponent_img_7_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function MessageComponent_video_9_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function MessageComponent_div_10_div_1_img_1_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "img", 11);
      }
    ...
    function MessageComponent_div_10_div_1_video_2_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function MessageComponent_div_10_div_1_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function MessageComponent_div_10_p_2_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "p");
    ...
    function MessageComponent_div_10_div_3_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 15);
    ...
    var MessageComponent = /*#__PURE__*/function () {
      ...
      _createClass(MessageComponent, [{
        ...
        value: function ngOnInit() {
          ...
          if (!src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].production && this.message.content.indexOf(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].SERVER_URL) == -1 && (this.message.type === src_app_models_message__WEBPACK_IMPORTED_MODULE_1__["MessageType"].Image || this.message.type === src_app_models_message__WEBPACK_IMPORTED_MODULE_1__["MessageType"].Video || this.message.type === src_app_models_message__WEBPACK_IMPORTED_MODULE_1__["MessageType"].File)) {
          ...
          if (this.message.type === src_app_models_message__WEBPACK_IMPORTED_MODULE_1__["MessageType"].Url) {
            this.chatService.getUrlMetadata(this.message.content).subscribe(function (res) {
              if (res.success) {
                _this5.metadata = res.data.metadata;
                _this5.metadata.url = _this5.message.content;
                if (_this5.message.content.indexOf(_this5.metadata.title) > 1) _this5.hideinfo = true;
                window["scrollToBottom"]();
              }
            });
          }
    ...
    MessageComponent.ɵfac = function MessageComponent_Factory(t) {
      return new (t || MessageComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_chat_service__WEBPACK_IMPORTED_MODULE_2__["ChatService"]));
    };
    ...
    MessageComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 16,
      vars: 18,
      consts: [["class", "col-lg-1 col-md-2 col-xs-2 msg-user-img", 4, "ngIf"], [1, "col-lg-10", "col-md-9", "col-xs-10", "p-l-r-0", 3, "id", "ngClass"], [1, "col-md-12", "col-xs-12", "p-l-r-0"], [1, "msg-name"], [1, "col-md-12", "col-xs-12", "msg-content", 3, "ngClass"], [4, "ngIf"], [3, "src", "alt", 4, "ngIf"], ["controls", "", "class", "card-img-top", "alt", "message.content", 3, "src", 4, "ngIf"], [1, "msg-time"], [1, "col-lg-1", "col-md-2", "col-xs-2", "msg-user-img"], [3, "src"], [3, "src", "alt"], ["target", "_blank", 3, "href"], ["controls", "", "alt", "message.content", 1, "card-img-top", 3, "src"], [3, "ngClass", 4, "ngIf"], [3, "ngClass"], [3, "src", 4, "ngIf"]],
      ...
      pipes: [_pipes_time_ago_pipe__WEBPACK_IMPORTED_MODULE_5__["TimeAgoPipe"]],
  ...
  function srcAppComponentsDashboardDashboardComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _max_video_call_max_video_call_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ../max-video-call/max-video-call.component */
    "./src/app/components/max-video-call/max-video-call.component.ts");
    /* harmony import */


    var _chat_menu_chat_menu_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../chat-menu/chat-menu.component */
    "./src/app/components/chat-menu/chat-menu.component.ts");
    /* harmony import */


    var _chat_window_chat_window_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../chat-window/chat-window.component */
    "./src/app/components/chat-window/chat-window.component.ts");
    /* harmony import */


    var _right_panel_right_panel_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../right-panel/right-panel.component */
    "./src/app/components/right-panel/right-panel.component.ts");
    ...
    DashboardComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 6,
      vars: 0,
      consts: [[1, "layout"], [1, "content"], ["app-chat-menu", "", 1, "sidebar-group", "hidden-xs"], ["app-chat-window", "", 1, "chat", "hidden-xs"], ["app-right-panel", "", 1, "col-lg-2", "col-lg-offset-10", "col-md-3", "col-md-offset-9", "col-xs-12", "p-l-r-0", "profile-panel"]],
      ...
      directives: [_max_video_call_max_video_call_component__WEBPACK_IMPORTED_MODULE_1__["MaxVideoCallComponent"], _chat_menu_chat_menu_component__WEBPACK_IMPORTED_MODULE_2__["ChatMenuComponent"], _chat_window_chat_window_component__WEBPACK_IMPORTED_MODULE_3__["ChatWindowComponent"], _right_panel_right_panel_component__WEBPACK_IMPORTED_MODULE_4__["RightPanelComponent"]],
  ...
  /***/
  function srcAppComponentsIncomingCallIncomingCallComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "IncomingCallComponent", function () {
    ...
    var src_app_services_call_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! src/app/services/call.service */
    "./src/app/services/call.service.ts");
    /* harmony import */
    ...
    function IncomingCallComponent_div_0_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function IncomingCallComponent_div_0_Template_div_click_8_listener() {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function IncomingCallComponent_div_0_Template_div_click_12_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r88);

          var ctx_r89 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r89.reject();
        });
    ...
    var IncomingCallComponent = /*#__PURE__*/function () {
      function IncomingCallComponent(callService, userService) {
        var _this6 = this;

        _classCallCheck(this, IncomingCallComponent);

        this.callService = callService;
        this.userService = userService;
        this.callService.incomingCall.subscribe(function (id) {
          _this6.callingUser = _this6.userService.getUserByUserId(id);
          console.log(_this6.callingUser);
        });
      }

      _createClass(IncomingCallComponent, [{
        key: "reject",
    ...
    IncomingCallComponent.ɵfac = function IncomingCallComponent_Factory(t) {
      return new (t || IncomingCallComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_call_service__WEBPACK_IMPORTED_MODULE_1__["CallService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_user_service__WEBPACK_IMPORTED_MODULE_2__["UserService"]));
    };

    IncomingCallComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: IncomingCallComponent,
      selectors: [["app-incoming-call"]],
      decls: 1,
      vars: 1,
      consts: [["ngDraggable", "", "class", "col-md-12 col-xs-12 p-l-r-0 incoming-call-window", 4, "ngIf"], ["ngDraggable", "", 1, "col-md-12", "col-xs-12", "p-l-r-0", "incoming-call-window"], [1, "col-md-8", "col-md-offset-2", "col-xs-8", "col-xs-offset-2", "incoming-caller"], [1, "col-md-12", "col-xs-12", "animation-border"], [3, "src"], [1, "col-md-12", "col-xs-12"], [1, "col-md-8", "col-md-offset-2", "col-xs-8", "col-xs-offset-2", "m-t-25", "call-action-container"], [1, "call-option", "accept", 3, "click"], ["href", "javascript:void(0);"], [1, "call-option", "cancel", 3, "click"]],
      ...
      directives: [_angular_common__WEBPACK_IMPORTED_MODULE_3__["NgIf"], angular2_draggable__WEBPACK_IMPORTED_MODULE_4__["AngularDraggableDirective"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](IncomingCallComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  function srcAppComponentsLoaderLoaderComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    LoaderComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 21,
      vars: 0,
      consts: [[1, "loader-container", 2, "display", "none"], [1, "loading"], [1, "finger", "finger-1"], [1, "finger-item"], [1, "finger", "finger-2"], [1, "finger", "finger-3"], [1, "finger", "finger-4"], [1, "last-finger"], [1, "last-finger-item"]],
  ...
  function srcAppComponentsLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function LoginComponent_a_36_Template(rf, ctx) {
      if (rf & 1) {
        var _r5 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "a", 39);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function LoginComponent_a_36_Template_a_click_0_listener() {
      ...
      _createClass(LoginComponent, [{
        ...
        value: function signIn() {
          ...
          this.authService.authenticate(this.loginForm.value).subscribe(function (res) {
            _this7.waitingResponse = false;

            if (res) {
              _this7.router.navigate(["home"]);
            } else {
              _this7.message = "Invalid Credentials";
            }
          });
        }
      }, {
  ...
  /***/
  function srcAppComponentsMaxVideoCallMaxVideoCallComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "MaxVideoCallComponent", function () {
      return MaxVideoCallComponent;
    });
    /* harmony import */
    ...
    function MaxVideoCallComponent_div_0_video_1_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function MaxVideoCallComponent_div_0_div_10_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 15);
    ...
    function MaxVideoCallComponent_div_0_div_11_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function MaxVideoCallComponent_div_0_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function MaxVideoCallComponent_div_0_Template_a_click_2_listener() {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function MaxVideoCallComponent_div_0_Template_a_click_15_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r108);

          var ctx_r109 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r109.toggleScreen();
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function MaxVideoCallComponent_div_0_Template_a_click_17_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r108);

          var ctx_r110 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r110.toggleMute();
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function MaxVideoCallComponent_div_0_Template_a_click_19_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r108);

          var ctx_r111 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r111.disconnect();
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function MaxVideoCallComponent_div_0_Template_a_click_21_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r108);

          var ctx_r112 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r112.toggleVideo();
        });
    ...
    var MaxVideoCallComponent = /*#__PURE__*/function () {
      function MaxVideoCallComponent(callService, cdr) {
        _classCallCheck(this, MaxVideoCallComponent);
      ...
      _createClass(MaxVideoCallComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this8 = this;

          this.callService.remoteStreamSubject.subscribe(function (stream) {
            _this8.remoteStream = stream;

            _this8.cdr.detectChanges();
          });
          this.callService.localStreamSubject.subscribe(function (stream) {
            _this8.localStream = stream;

            _this8.cdr.detectChanges();
          });
          this.callService.streamSubject.subscribe(function (s) {
            if (s.id) _this8.streams[s.id] = s.stream;

            _this8.cdr.detectChanges();
          });
          this.callService.maximizeWindow.subscribe(function (flag) {
            _this8.maxWindow = flag;
            console.log("called");
        ...
        value: function getMainVideoStream() {
          if (this.streams[this.callService.ongoingCall.connectedUserId + "_screen"] && this.streams[this.callService.ongoingCall.connectedUserId + "_screen"].id) return this.streams[this.callService.ongoingCall.connectedUserId + "_screen"];else if (this.streams[this.callService.ongoingCall.connectedUserId + "_video"] && this.streams[this.callService.ongoingCall.connectedUserId + "_video"].id) return this.streams[this.callService.ongoingCall.connectedUserId + "_video"];else return null;
        }
      }, {
        key: "getSecondaryVideoStream",
        value: function getSecondaryVideoStream() {
          if (this.streams[this.callService.ongoingCall.connectedUserId + "_screen"] && this.streams[this.callService.ongoingCall.connectedUserId + "_screen"].id && this.streams[this.callService.ongoingCall.connectedUserId + "_video"] && this.streams[this.callService.ongoingCall.connectedUserId + "_video"].id) {
    ...
    MaxVideoCallComponent.ɵfac = function MaxVideoCallComponent_Factory(t) {
      return new (t || MaxVideoCallComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_call_service__WEBPACK_IMPORTED_MODULE_1__["CallService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["ChangeDetectorRef"]));
    };

    MaxVideoCallComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: MaxVideoCallComponent,
      selectors: [["app-max-video-call"]],
      decls: 1,
      vars: 1,
      consts: [["class", "max-video-call container-fluid embed-responsive embed-responsive-4by3", 4, "ngIf"], [1, "max-video-call", "container-fluid", "embed-responsive", "embed-responsive-4by3"], ["class", "embed-responsive-item", "autoplay", "", "muted", "", 3, "srcObject", 4, "ngIf"], ["href", "javascript:void(0);", 1, "minimize", 3, "click"], [1, "col-md-8", "user-details"], [1, "name"], [1, "time"], ["class", "col-md-2 p-l-r-0 child-left", 4, "ngIf"], ["class", "col-md-2 p-l-r-0 child-right", 4, "ngIf"], [1, "col-md-12", "call-action"], ["href", "javascript:void(0);", 1, "screenshare", 3, "ngClass", "click"], ["href", "javascript:void(0);", 1, "mute", 3, "ngClass", "click"], ["href", "javascript:void(0);", 1, "disconnect", 3, "click"], ["href", "javascript:void(0);", 1, "video", 3, "ngClass", "click"], ["autoplay", "", "muted", "", 1, "embed-responsive-item", 3, "srcObject"], [1, "col-md-2", "p-l-r-0", "child-left"], [1, "embed-responsive", "embed-responsive-16by9"], ["muted", "", "autoplay", "", 1, "embed-responsive-item", 3, "srcObject"], [1, "col-md-2", "p-l-r-0", "child-right"]],
      template: function MaxVideoCallComponent_Template(rf, ctx) {
        if (rf & 1) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](MaxVideoCallComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppComponentsMinCallWindowMinCallWindowComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "MinCallWindowComponent", function () {
      return MinCallWindowComponent;
    });
    /* harmony import */
    ...
    function MinCallWindowComponent_div_0_div_10_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 15);
    ...
    function MinCallWindowComponent_div_0_div_11_video_3_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function MinCallWindowComponent_div_0_div_11_div_4_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function MinCallWindowComponent_div_0_div_11_div_5_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 28);
    ...
    function MinCallWindowComponent_div_0_div_11_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function MinCallWindowComponent_div_0_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function MinCallWindowComponent_div_0_Template_a_click_1_listener() {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function MinCallWindowComponent_div_0_Template_a_click_15_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r98);

          var ctx_r99 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r99.toggleScreen();
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function MinCallWindowComponent_div_0_Template_a_click_17_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r98);

          var ctx_r100 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r100.toggleMute();
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function MinCallWindowComponent_div_0_Template_a_click_19_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r98);

          var ctx_r101 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r101.disconnect();
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function MinCallWindowComponent_div_0_Template_a_click_21_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r98);

          var ctx_r102 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r102.toggleVideo();
        });
    ...
    function MinCallWindowComponent_video_1_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var MinCallWindowComponent = /*#__PURE__*/function () {
      function MinCallWindowComponent(callService, cdr) {
        _classCallCheck(this, MinCallWindowComponent);
      ...
      _createClass(MinCallWindowComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this9 = this;

          this.callService.remoteStreamSubject.subscribe(function (stream) {
            _this9.remoteStream = stream;

            _this9.cdr.detectChanges();
          });
          this.callService.localStreamSubject.subscribe(function (stream) {
            _this9.localStream = stream;

            _this9.cdr.detectChanges();
          });
          this.callService.streamSubject.subscribe(function (s) {
            if (s.id) _this9.streams[s.id] = s.stream;

            _this9.cdr.detectChanges();
          });
          this.callService.maximizeWindow.subscribe(function (flag) {
            _this9.maxWindow = flag;
    ...
    MinCallWindowComponent.ɵfac = function MinCallWindowComponent_Factory(t) {
      return new (t || MinCallWindowComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_call_service__WEBPACK_IMPORTED_MODULE_1__["CallService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["ChangeDetectorRef"]));
    };

    MinCallWindowComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: MinCallWindowComponent,
      selectors: [["app-min-call-window"]],
      decls: 2,
      vars: 2,
      consts: [["class", "col-md-12 p-l-r-0 min-call-window", 4, "ngIf"], ["class", "hidden", "autoplay", "", "class", "embed-responsive-item", 3, "srcObject", 4, "ngIf"], [1, "col-md-12", "p-l-r-0", "min-call-window"], ["href", "javascript:void(0);", 1, "maximize", 3, "click"], [1, "col-md-12"], ["aria-hidden", "true", 1, "glyphicon", "glyphicon-star", "fav-icon"], [1, "caller-name"], [1, "call-time"], ["class", "col-md-12 p-l-r-0 audio", 4, "ngIf"], ["class", "col-md-12 p-l-r-0 video", 4, "ngIf"], [1, "col-md-12", "call-action"], ["href", "javascript:void(0);", 1, "screenshare", 3, "ngClass", "click"], ["href", "javascript:void(0);", 1, "mute", 3, "ngClass", "click"], ["href", "javascript:void(0);", 1, "disconnect", 3, "click"], ["href", "javascript:void(0);", 1, "video", 3, "ngClass", "click"], [1, "col-md-12", "p-l-r-0", "audio"], [1, "col-md-12", "user-list"], ["src", "assets/img/user3.jpg"], ["src", "assets/img/user5.jpg"], [1, "col-md-12", "p-l-r-0", "video"], [1, "col-md-12", "p-l-r-0", "master"], [1, "embed-responsive", "embed-responsive-4by3"], ["autoplay", "", "muted", "", "class", "embed-responsive-item", 3, "srcObject", 4, "ngIf"], ["class", "col-md-4 p-l-r-0 child-left", 4, "ngIf"], ["class", "col-md-4 p-l-r-0 child", 4, "ngIf"], ["autoplay", "", "muted", "", 1, "embed-responsive-item", 3, "srcObject"], [1, "col-md-4", "p-l-r-0", "child-left"], ["muted", "", "autoplay", "", 1, "embed-responsive-item", 3, "srcObject"], [1, "col-md-4", "p-l-r-0", "child"], ["autoplay", "", 1, "embed-responsive-item", 3, "srcObject"]],
      template: function MinCallWindowComponent_Template(rf, ctx) {
        if (rf & 1) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](MinCallWindowComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppComponentsModelsAddFriendModelAddFriendModelComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "AddFriendModelComponent", function () {
      return AddFriendModelComponent;
    });
    /* harmony import */
    ...
    var AddFriendModelComponent = /*#__PURE__*/function () {
      function AddFriendModelComponent() {
        _classCallCheck(this, AddFriendModelComponent);
      }

      _createClass(AddFriendModelComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }]);
    ...
    AddFriendModelComponent.ɵfac = function AddFriendModelComponent_Factory(t) {
      return new (t || AddFriendModelComponent)();
    };

    AddFriendModelComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: AddFriendModelComponent,
      selectors: [["app-add-friend-model"]],
      decls: 24,
      vars: 0,
      consts: [["id", "addFriends", "tabindex", "-1", "role", "dialog", "aria-labelledby", "exampleModalLabel", "aria-hidden", "true", 1, "modal", "fade"], ["role", "document", 1, "modal-dialog", "modal-dialog-centered", "modal-dialog-zoom"], [1, "modal-content"], [1, "modal-header"], [1, "modal-title"], [1, "ti-user"], ["type", "button", "data-dismiss", "modal", "aria-label", "Close", 1, "close"], [1, "ti-close"], [1, "modal-body"], [1, "alert", "alert-info"], [1, "form-group"], ["for", "emails", 1, "col-form-label"], ["type", "text", "id", "emails", 1, "form-control"], ["for", "message", 1, "col-form-label"], ["id", "message", 1, "form-control"], [1, "modal-footer"], ["type", "button", 1, "btn", "btn-primary"]],
      template: function AddFriendModelComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AddFriendModelComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppComponentsModelsCallModelCallModelComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CallModelComponent", function () {
      return CallModelComponent;
    });
    /* harmony import */
    ...
    var CallModelComponent = /*#__PURE__*/function () {
      function CallModelComponent() {
        _classCallCheck(this, CallModelComponent);
      }

      _createClass(CallModelComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }]);
    ...
    CallModelComponent.ɵfac = function CallModelComponent_Factory(t) {
      return new (t || CallModelComponent)();
    };

    CallModelComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: CallModelComponent,
      selectors: [["app-call-model"]],
      decls: 16,
      vars: 0,
      consts: [["id", "call", "tabindex", "-1", "role", "dialog", "aria-labelledby", "exampleModalLabel", "aria-hidden", "true", 1, "modal", "call", "fade"], ["role", "document", 1, "modal-dialog", "modal-dialog-centered", "modal-dialog-zoom"], [1, "modal-content"], [1, "modal-body"], [1, "call"], [1, "call-background", 2, "background", "url(/assets/images/call-bg.png)"], [1, "mb-4", "avatar", "avatar-xl"], ["src", "https://banner2.kisspng.com/20180523/tha/kisspng-businessperson-computer-icons-avatar-clip-art-lattice-5b0508dc6a3a10.0013931115270566044351.jpg", 1, "rounded-circle"], [1, "text-center"], [1, "action-button"], ["type", "button", "data-dismiss", "modal", 1, "btn", "btn-danger", "btn-floating", "btn-lg"], [1, "ti-close"], ["type", "button", 1, "btn", "btn-success", "btn-pulse", "btn-floating", "btn-lg"], [1, "fa", "fa-phone"]],
      template: function CallModelComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CallModelComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppComponentsModelsDisconnectedModelDisconnectedModelComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "DisconnectedModelComponent", function () {
      return DisconnectedModelComponent;
    });
    /* harmony import */
    ...
    var DisconnectedModelComponent = /*#__PURE__*/function () {
      function DisconnectedModelComponent() {
        _classCallCheck(this, DisconnectedModelComponent);
      }

      _createClass(DisconnectedModelComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }]);
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](DisconnectedModelComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppComponentsModelsEditProfileModelEditProfileModelComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "EditProfileModelComponent", function () {
      return EditProfileModelComponent;
    });
    /* harmony import */
    ...
    function EditProfileModelComponent_img_45_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var EditProfileModelComponent = /*#__PURE__*/function () {
      function EditProfileModelComponent(userService, formBuilder) {
        _classCallCheck(this, EditProfileModelComponent);
      ...
      _createClass(EditProfileModelComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this10 = this;

          this.userService.userSubject.subscribe(function (d) {
            _this10.user = d;
            if (d.profileImagePath && d.profileImagePath.indexOf("https://ui-avatars.com") === -1) _this10.profileImagePath = "".concat(src_environments_environment_prod__WEBPACK_IMPORTED_MODULE_3__["environment"].SERVER_URL).concat(d.profileImagePath);
            _this10.profileForm = _this10.formBuilder.group({
              firstName: [_this10.user.firstName, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
              lastName: [_this10.user.lastName, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
              mobile: [_this10.user.mobile],
              website: [_this10.user.website],
              city: [_this10.user.city],
              state: [_this10.user.state],
              country: [_this10.user.country],
              bio: [_this10.user.bio],
              profileImagePath: [_this10.user.profileImagePath],
              facebookProfileUrl: [_this10.user.facebookProfileUrl],
              linkedInProfileUrl: [_this10.user.linkedInProfileUrl],
              twitterProfileUrl: [_this10.user.twitterProfileUrl],
              googlePlusProfileUrl: [_this10.user.googlePlusProfileUrl],
              instagramProfileUrl: [_this10.user.instagramProfileUrl],
              dribbleProfileUrl: [_this10.user.dribbleProfileUrl]
            });
          });
        ...
        key: "selectImage",
        value: function selectImage(file) {
          var _this11 = this;
          ...
          reader.onload = function (e) {
            setTimeout(function () {
              _this11.profileImagePath = e.target.result;
            });
          };
        ...
        value: function submit() {
          ...
          this.userService.updateUserProfile(this.profileForm.value, this.imageSelected).subscribe(function (res) {
            if (res) _this12.button_text = "Saved successfully";else _this12.button_text = "Failed";
            setTimeout(function () {
              _this12.button_text = "Save";
            }, 3000);
          });
        }
      }, {
    ...
    EditProfileModelComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function EditProfileModelComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function EditProfileModelComponent_Template_input_change_47_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditProfileModelComponent_Template_button_click_133_listener() {
            return ctx.submit();
          });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](EditProfileModelComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppComponentsModelsNewGroupModelNewGroupModelComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "NewGroupModelComponent", function () {
      return NewGroupModelComponent;
    });
    /* harmony import */
    ...
    var toppy__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! toppy */
    "./node_modules/toppy/__ivy_ngcc__/fesm2015/toppy.js");
    /* harmony import */
    ...
    function NewGroupModelComponent_ng_template_22_li_2_Template(rf, ctx) {
      if (rf & 1) {
        var _r48 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "li", 27);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function NewGroupModelComponent_ng_template_22_li_2_Template_li_click_0_listener() {
          ...
          return ctx_r47.addUser(user_r46);
        });

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "div", 28);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function NewGroupModelComponent_ng_template_22_li_2_Template_div_click_1_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r48);
          ...
          return ctx_r49.addUser(user_r46);
        });
    ...
    function NewGroupModelComponent_ng_template_22_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function NewGroupModelComponent_div_24_figure_2_Template(rf, ctx) {
      if (rf & 1) {
        var _r53 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "figure", 36);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function NewGroupModelComponent_div_24_figure_2_Template_figure_click_0_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r53);

          var user_r51 = ctx.$implicit;

          var ctx_r52 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2);

          return ctx_r52.removeUser(user_r51);
        });
    ...
    function NewGroupModelComponent_div_24_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var NewGroupModelComponent = /*#__PURE__*/function () {
      function NewGroupModelComponent(_toppy, userService, formBuilder, chatService) {
        _classCallCheck(this, NewGroupModelComponent);
      ...
      _createClass(NewGroupModelComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          ...
          var position = new toppy__WEBPACK_IMPORTED_MODULE_1__["RelativePosition"]({
            placement: toppy__WEBPACK_IMPORTED_MODULE_1__["OutsidePlacement"].BOTTOM_LEFT,
            src: this.el.nativeElement
          });
          this.overlay = this._toppy.position(position).content(this.tpl) // template ref
          .create();
          this.fetchAllUsers();
        }
      }, {
        ...
        value: function fetchAllUsers() {
          ...
          this.userService.activeUsers.subscribe(function (res) {
            _this13.users = res;
            _this13.filteredUsers = res;
          });
        }
      }, {
        key: "inputChange",
        value: function inputChange() {
          ...
          this.filteredUsers = this.users.filter(function (u) {
            return (u.firstName + " " + u.lastName).toUpperCase().includes(_this14.el.nativeElement.value.toUpperCase()) && !_this14.selectedUsers.some(function (s) {
        ...
        value: function submit() {
          ...
          this.chatService.createGroup(data).subscribe(function (res) {});
        }
      }, {
        key: "addUser",
        value: function addUser(user) {
          if (!this.selectedUsers.filter(function (v) {
    ...
    NewGroupModelComponent.ɵfac = function NewGroupModelComponent_Factory(t) {
      return new (t || NewGroupModelComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](toppy__WEBPACK_IMPORTED_MODULE_1__["Toppy"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_user_service__WEBPACK_IMPORTED_MODULE_2__["UserService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_chat_service__WEBPACK_IMPORTED_MODULE_4__["ChatService"]));
    };

    NewGroupModelComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: NewGroupModelComponent,
      selectors: [["app-new-group-model"]],
      viewQuery: function NewGroupModelComponent_Query(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵstaticViewQuery"](_c0, true);
      ...
      template: function NewGroupModelComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function NewGroupModelComponent_Template_input_click_18_listener() {
            return ctx.open();
          })("blur", function NewGroupModelComponent_Template_input_blur_18_listener() {
            return ctx.close();
          })("input", function NewGroupModelComponent_Template_input_input_18_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function NewGroupModelComponent_Template_button_click_30_listener() {
            return ctx.submit();
          });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](NewGroupModelComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
        ...
        return [{
          type: toppy__WEBPACK_IMPORTED_MODULE_1__["Toppy"]
        }, {
          type: src_app_services_user_service__WEBPACK_IMPORTED_MODULE_2__["UserService"]
        }, {
  ...
  /***/
  function srcAppComponentsModelsSettingsModelSettingsModelComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "SettingsModelComponent", function () {
      return SettingsModelComponent;
    });
    /* harmony import */
    ...
    var SettingsModelComponent = /*#__PURE__*/function () {
      function SettingsModelComponent() {
        _classCallCheck(this, SettingsModelComponent);
      }

      _createClass(SettingsModelComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }]);
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SettingsModelComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppComponentsProfilePanelProfilePanelComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_app_models_message__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! src/app/models/message */
    "./src/app/models/message.ts");
    /* harmony import */
    ...
    function ProfilePanelComponent_div_0_p_22_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "p");
    ...
    function ProfilePanelComponent_div_0_li_24_Template(rf, ctx) {
      if (rf & 1) {
        var _r82 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "li", 14);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ProfilePanelComponent_div_0_li_24_Template_li_click_0_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r82);

          var file_r80 = ctx.$implicit;

          var ctx_r81 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2);

          return ctx_r81.handleFileClick(file_r80.id);
        });
    ...
    function ProfilePanelComponent_div_0_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function ProfilePanelComponent_div_0_Template_input_ngModelChange_15_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r84);

          var ctx_r83 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r83.query = $event;
        })("keydown", function ProfilePanelComponent_div_0_Template_input_keydown_15_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r84);

          var ctx_r85 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r85.queryChange();
        });
    ...
    var ProfilePanelComponent = /*#__PURE__*/function () {
      function ProfilePanelComponent(chatService, userService) {
        var _this16 = this;
        ...
        this.query = "";
        this.files = [];
        this.userService.userSubject.subscribe(function (user) {
          _this16.user = user;
        });
        this.chatService.activeUserSubject.subscribe(function (user) {
          _this16.activeUser = user;
          _this16.query = "";
        ...
        this.chatService.activeMessages.subscribe(function (messages) {
          ...
          messages.forEach(function (msg) {
            if (msg.type == src_app_models_message__WEBPACK_IMPORTED_MODULE_3__["MessageType"].File || msg.type == src_app_models_message__WEBPACK_IMPORTED_MODULE_3__["MessageType"].Video || msg.type == src_app_models_message__WEBPACK_IMPORTED_MODULE_3__["MessageType"].Image) {
              _this16.files.push({
      ...
      _createClass(ProfilePanelComponent, [{
        ...
        key: "getFileName",
        value: function getFileName(msg) {
          return msg.content.split("/").slice(-1).pop();
        }
      }, {
        key: "handleFileClick",
        value: function handleFileClick(id) {
    ...
    ProfilePanelComponent.ɵfac = function ProfilePanelComponent_Factory(t) {
      return new (t || ProfilePanelComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_chat_service__WEBPACK_IMPORTED_MODULE_2__["ChatService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_user_service__WEBPACK_IMPORTED_MODULE_1__["UserService"]));
    };

    ProfilePanelComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: ProfilePanelComponent,
      selectors: [["app-profile-panel"]],
      decls: 1,
      vars: 1,
      consts: [["class", "col-md-12 col-xs-12 p-l-r-0 chat-user-details", 4, "ngIf"], [1, "col-md-12", "col-xs-12", "p-l-r-0", "chat-user-details"], [1, "col-md-6", "col-md-offset-3", "col-xs-6", "col-xs-offset-3", "user-img"], [3, "src"], [1, "user-status", "available"], [1, "user-status", 3, "ngClass"], [1, "col-md-12", "col-xs-12"], [1, "status", "available-status-details"], [1, "col-md-12", "col-xs-12", "p-l-r-0", "chat-user-option", "m-t-25"], ["type", "text", "placeholder", "Search in Conversation", 3, "ngModel", "ngModelChange", "keydown"], ["href", "javascript:void(0);", 1, "starred"], [1, "col-md-12", "col-xs-12", "p-l-r-0", "chat-user-option"], [4, "ngIf"], [3, "click", 4, "ngFor", "ngForOf"], [3, "click"], ["href", "javascript:void(0);", 1, "doc"]],
  ...
  function srcAppComponentsRegisterRegisterComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function RegisterComponent_a_39_Template(rf, ctx) {
      if (rf & 1) {
        var _r11 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "a", 39);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function RegisterComponent_a_39_Template_a_click_0_listener() {
      ...
      _createClass(RegisterComponent, [{
        ...
        value: function register() {
          ...
          this.authService.register(this.registerForm.value).subscribe(function (res) {
            _this17.waitingResponse = false;

            if (res) {
              _this17.router.navigate(["home"]);
            } else {
              _this17.message = "User Already Exists";
            }
          });
        } // convenience getter for easy access to form fields
  ...
  /***/
  function srcAppComponentsRightPanelRightPanelComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _incoming_call_incoming_call_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../incoming-call/incoming-call.component */
    "./src/app/components/incoming-call/incoming-call.component.ts");
    /* harmony import */


    var _min_call_window_min_call_window_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../min-call-window/min-call-window.component */
    "./src/app/components/min-call-window/min-call-window.component.ts");
    /* harmony import */


    var _profile_panel_profile_panel_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../profile-panel/profile-panel.component */
    "./src/app/components/profile-panel/profile-panel.component.ts");

    var _c0 = ["app-right-panel", ""];

    var _c1 = function _c1() {
      return ["/login"];
    };

    var RightPanelComponent = /*#__PURE__*/function () {
      function RightPanelComponent(userService) {
        var _this18 = this;

        _classCallCheck(this, RightPanelComponent);
      ...
      _createClass(RightPanelComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }]);
    ...
    RightPanelComponent.ɵfac = function RightPanelComponent_Factory(t) {
      return new (t || RightPanelComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_user_service__WEBPACK_IMPORTED_MODULE_1__["UserService"]));
    };

    RightPanelComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: RightPanelComponent,
      selectors: [["", "app-right-panel", ""]],
      attrs: _c0,
      decls: 17,
      vars: 4,
      consts: [[1, "col-md-12", "col-xs-12", "profile-panel-header"], [1, "col-lg-3", "col-lg-offset-1", "col-md-3", "col-xs-3", "col-xs-offset-2", "img-container"], [3, "src"], [1, "col-lg-7", "col-md-8", "col-md-offset-1", "col-xs-5", "p-l-0"], ["type", "button", "data-toggle", "dropdown", "aria-haspopup", "true", "aria-expanded", "false", 1, "btn", "dropdown-toggle", "name"], [1, "caret"], [1, "dropdown-menu"], ["href", "#"], [3, "routerLink"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](RightPanelComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  function srcAppComponentsSideMenuSideMenuComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      _createClass(SideMenuComponent, [{
        ...
        value: function ngOnInit() {
          ...
          document.addEventListener("swiped-right", function (e) {
            _this19.rightSwipe = true;
          });
          document.addEventListener("swiped-left", function (e) {
            _this19.rightSwipe = false;
          });
        }
      }, {
        key: "isMobile",
    ...
    SideMenuComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 34,
      vars: 0,
      consts: [[1, "col-md-1", "col-sm-3", "col-xs-3", "left-profile-panel"], [1, "col-md-12", "profile-pic"], [1, "profile-status", "available"], ["src", "assets/img/user.jfif "], [1, "col-md-12", "p-l-r-0"], ["type", "button", "data-toggle", "dropdown", "aria-haspopup", "true", "aria-expanded", "false", 1, "btn", "btn-default", "dropdown-toggle", "status-change", "available-status"], [1, "caret"], [1, "dropdown-menu", "status-dropdown"], ["href", "#"], [1, "col-md-12", "p-l-r-0", "m-t-100"], [1, "profile-option"], ["aria-hidden", "true", 1, "glyphicon", "glyphicon-home"], [1, "notification-lit"], ["aria-hidden", "true", 1, "glyphicon", "glyphicon-send"], ["aria-hidden", "true", 1, "glyphicon", "glyphicon-inbox"], ["aria-hidden", "true", 1, "glyphicon", "glyphicon-user"], ["aria-hidden", "true", 1, "glyphicon", "glyphicon-bell"], [1, "col-md-12", "p-l-r-0", "profile-setting"], ["aria-hidden", "true", 1, "glyphicon", "glyphicon-cog"]],
  ...
  function srcAppComponentsUserInfoUserInfoComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _c0 = ["app-user-info", ""];

    function UserInfoComponent_div_0_hr_16_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "hr");
      }
    }

    function UserInfoComponent_div_0_div_17_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 14);
    ...
    function UserInfoComponent_div_0_hr_18_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "hr");
      }
    }

    function UserInfoComponent_div_0_div_19_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 14);
    ...
    function UserInfoComponent_div_0_hr_20_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "hr");
      }
    }

    function UserInfoComponent_div_0_div_21_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 14);
    ...
    function UserInfoComponent_div_0_hr_22_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "hr");
      }
    }

    function UserInfoComponent_div_0_div_23_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 14);
    ...
    function UserInfoComponent_div_0_hr_24_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "hr");
      }
    }

    function UserInfoComponent_div_0_div_25_li_4_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function UserInfoComponent_div_0_div_25_li_5_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "li", 18);
    ...
    function UserInfoComponent_div_0_div_25_li_6_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "li", 18);
    ...
    function UserInfoComponent_div_0_div_25_li_7_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "li", 18);
    ...
    function UserInfoComponent_div_0_div_25_li_8_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "li", 18);
    ...
    function UserInfoComponent_div_0_div_25_li_9_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "li", 18);
    ...
    function UserInfoComponent_div_0_div_25_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 14);
    ...
    var _c2 = function _c2(a0, a1) {
      return {
        "avatar-state-success": a0,
        "avatar-state-danger": a1
      };
    };
    ...
    function UserInfoComponent_div_0_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function UserInfoComponent_div_0_Template_li_click_5_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r39);

          var ctx_r38 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r38.closeSidebar();
        });
    ...
    var UserInfoComponent = /*#__PURE__*/function () {
      function UserInfoComponent(userService) {
        ...
        this.userService = userService;
        this.opened = false;
        this.userService.openProfile.subscribe(function (user) {
          if (user) {
            _this20.user = user;
            _this20.opened = true;
    ...
    UserInfoComponent.ɵfac = function UserInfoComponent_Factory(t) {
      return new (t || UserInfoComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_user_service__WEBPACK_IMPORTED_MODULE_1__["UserService"]));
    };
  ...
  /***/
  function srcAppComponentsUserProfileImageUserProfileImageComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "UserProfileImageComponent", function () {
      return UserProfileImageComponent;
    });
    /* harmony import */
    ...
    var UserProfileImageComponent = /*#__PURE__*/function () {
      function UserProfileImageComponent() {
        _classCallCheck(this, UserProfileImageComponent);
      }

      _createClass(UserProfileImageComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }]);
    ...
    UserProfileImageComponent.ɵfac = function UserProfileImageComponent_Factory(t) {
      return new (t || UserProfileImageComponent)();
    };

    UserProfileImageComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: UserProfileImageComponent,
      selectors: [["app-user-profile-image"]],
      decls: 2,
      vars: 0,
      template: function UserProfileImageComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "p");
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](UserProfileImageComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppHelperPeerConnectionTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "PeerConnection", function () {
      return PeerConnection;
    });

    var PeerConnection = /*#__PURE__*/function () {
      function PeerConnection(id, track, stream, sender, processPeerStream) {
        ...
        this.createPeerConnection = function () {
          ...
          if (flag) this.pc.createOffer(this.setLocalAndSendOffer.bind(this), this.handleCreateOfferError.bind(this));
        };
        ...
        this.processOffer = function (offer) {
          ...
          this.pc.setRemoteDescription(new RTCSessionDescription(offer)); //this.addLog("Sending answer to peer.");

          this.pc.createAnswer().then(this.setLocalAndSendAnswer.bind(this), this.onCreateSessionDescriptionError.bind(this));
        };

        this.setLocalAndSendAnswer = function (sessionDescription) {
          this.pc.setLocalDescription(sessionDescription); //this.addLog("setLocalAndSendAnswer sending message", sessionDescription);
        ...
        this.handleIceCandidate = function (event) {
          ...
          } else {//this.addLog("End of candidates.");
          }
        };
      ...
      _createClass(PeerConnection, [{
        ...
        key: "getPeerConnectionConfig",
        value: function getPeerConnectionConfig() {
          return {
            iceServers: [{
    ...
    var PeerConnectionSignal = function PeerConnectionSignal() {
      _classCallCheck(this, PeerConnectionSignal);
    };
  ...
  /***/
  function srcAppModelsCallTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CallSignal", function () {
      return CallSignal;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "CallSignalType", function () {
      return CallSignalType;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "CallStatus", function () {
      return CallStatus;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "OngoingCall", function () {
      return OngoingCall;
    });

    var CallSignal = function CallSignal() {
      _classCallCheck(this, CallSignal);
    };
    ...
    var OngoingCall = function OngoingCall() {
  ...
  /***/
  function srcAppModelsSignalTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "OutgoingSignal", function () {
      return OutgoingSignal;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "IncomingSignal", function () {
      return IncomingSignal;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "SignalType", function () {
      return SignalType;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "OutgoingSignalData", function () {
      return OutgoingSignalData;
    });

    var OutgoingSignal = function OutgoingSignal() {
      _classCallCheck(this, OutgoingSignal);
    };

    var IncomingSignal = function IncomingSignal() {
      _classCallCheck(this, IncomingSignal);
    };
    ...
    var OutgoingSignalData = function OutgoingSignalData() {
      _classCallCheck(this, OutgoingSignalData);
    };
    /***/
  ...
  /***/
  function srcAppModelsStreamTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "StreamOptions", function () {
  ...
  /***/
  function srcAppPipesMessagePipeTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var MessagePipe = /*#__PURE__*/function () {
  ...
  function srcAppPipesTimeAgoPipeTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var javascript_time_ago__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! javascript-time-ago */
    "./node_modules/javascript-time-ago/index.js");
    /* harmony import */


    var javascript_time_ago_locale_en__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! javascript-time-ago/locale/en */
    "./node_modules/javascript-time-ago/locale/en/index.js");
    /* harmony import */


    var javascript_time_ago_locale_en__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(javascript_time_ago_locale_en__WEBPACK_IMPORTED_MODULE_2__); // Load locale-specific relative date/time formatting rules.
  ...
  function srcAppServicesApiServiceTs(module, __webpack_exports__, __webpack_require__) {
      ...
      _createClass(ApiService, [{
        ...
        value: function get(path) {
          ...
          return rxjs__WEBPACK_IMPORTED_MODULE_2__["Observable"].create(function (o) {
            _this21.http.get("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].SERVER_URL).concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].API_PATH).concat(path), _this21.httpOptions).subscribe(function (d) {
              o.next(d);
            }, function (e) {
              o.next(e);
            });
        ...
        value: function post(path, data) {
          ...
          return rxjs__WEBPACK_IMPORTED_MODULE_2__["Observable"].create(function (o) {
            _this22.http.post("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].SERVER_URL).concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].API_PATH).concat(path), data, _this22.httpOptions).subscribe(function (d) {
              o.next(d);
            }, function (e) {
              o.next(e);
            });
    ...
    ApiService.ɵfac = function ApiService_Factory(t) {
      return new (t || ApiService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](ngx_cookie_service__WEBPACK_IMPORTED_MODULE_3__["CookieService"]));
    };
  ...
  function srcAppServicesAuthServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _models_signal__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ../models/signal */
    "./src/app/models/signal.ts");
    /* harmony import */
    ...
    var AuthService = /*#__PURE__*/function () {
      function AuthService(apiService, cookieService, userService, socketService, router) {
      ...
      _createClass(AuthService, [{
        ...
        value: function isLoggedIn() {
          ...
          return new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](function (ob) {
            if (_this23.loggedInUserId) ob.next(true);else {
              _this23.apiService.get("/user/profile").subscribe(function (res) {
                if (res.success) {
                  _this23.userService.setUser(res.data.user);

                  _this23.registerUserOnSocker(_this23.cookieService.get("token"));

                  _this23.loggedInUserId = res.data.user.userId;
                  ob.next(true);
                } else {
        ...
        value: function authenticate(cred) {
          ...
          return rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"].create(function (o) {
            _this24.apiService.post("/authenticate", cred).subscribe(function (res) {
              if (res.success) {
                window["$"](".loader-container").show();

                _this24.setToken(res.data.token);

                setTimeout(function () {
                  _this24.registerUserOnSocker(res.data.token);
                }, 0);

                if (!res.data.user.profileImagePath) {
                  res.data.user.profileImagePath = "https://ui-avatars.com/api/?name=".concat(res.data.user.firstName, "+").concat(res.data.user.lastName, "&background=0D8ABC&color=fff&rounded=true&size=150");
                }

                _this24.userService.setUser(res.data.user);
        ...
        key: "registerUserOnSocker",
        value: function registerUserOnSocker(token) {
          var signal = new _models_signal__WEBPACK_IMPORTED_MODULE_7__["OutgoingSignal"]();
        ...
        value: function register(user) {
          ...
          return rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"].create(function (o) {
            _this25.apiService.post("/register", user).subscribe(function (res) {
              if (res.success) {
                window["$"](".loader-container").show();

                _this25.setToken(res.data.token);

                _this25.registerUserOnSocker(res.data.token);

                _this25.userService.setUser(res.data.user);
  ...
  /***/
  function srcAppServicesCallServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _models_signal__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../models/signal */
    "./src/app/models/signal.ts");
    /* harmony import */
    ...
    var _models_call__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ../models/call */
    "./src/app/models/call.ts");
    /* harmony import */


    var _helper_PeerConnection__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ../helper/PeerConnection */
    "./src/app/helper/PeerConnection.ts");
    /* harmony import */


    var _models_stream__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ../models/stream */
    "./src/app/models/stream.ts");
    /* harmony import */
    ...
    var pcConfig = _helper_PeerConnection__WEBPACK_IMPORTED_MODULE_7__["PeerConnection"].getPeerConnectionConfig(); // Set up audio and video regardless of what devices are present.
    ...
    var CallService = /*#__PURE__*/function () {
      function CallService(socketService, userService) {
        var _this26 = this;
        ...
        this.user = this.userService.getUser();
        this.socketService.event("message").subscribe(function (_signal) {
          return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(_this26, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
            var signal;
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    _context.next = 4;
                    return this.processCallSignal(signal.data);
      ...
      _createClass(CallService, [{
        key: "processCallSignal",
        value: function processCallSignal(callSignal) {
          return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
            return regeneratorRuntime.wrap(function _callee2$(_context2) {
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    _context2.t0 = callSignal.type;
                    _context2.next = _context2.t0 === _models_message__WEBPACK_IMPORTED_MODULE_5__["MessageType"].InitiateCall ? 3 : _context2.t0 === _models_message__WEBPACK_IMPORTED_MODULE_5__["MessageType"].Busy ? 5 : _context2.t0 === _models_message__WEBPACK_IMPORTED_MODULE_5__["MessageType"].RejectCall ? 8 : _context2.t0 === _models_message__WEBPACK_IMPORTED_MODULE_5__["MessageType"].Disconnect ? 11 : _context2.t0 === _models_message__WEBPACK_IMPORTED_MODULE_5__["MessageType"].AcceptCall ? 14 : _context2.t0 === _models_message__WEBPACK_IMPORTED_MODULE_5__["MessageType"].Offer ? 20 : _context2.t0 === _models_message__WEBPACK_IMPORTED_MODULE_5__["MessageType"].Answer ? 22 : _context2.t0 === _models_message__WEBPACK_IMPORTED_MODULE_5__["MessageType"].Candidate ? 24 : 26;
                    break;
        ...
        key: "sendCallSignal",
        value: function sendCallSignal(id, type) {
          var data = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
          var signal = new _models_signal__WEBPACK_IMPORTED_MODULE_4__["OutgoingSignal"]();
            ...
            return regeneratorRuntime.wrap(function _callee3$(_context3) {
              while (1) {
                switch (_context3.prev = _context3.next) {
                  case 0:
                    _context3.next = 2;
                    return this.requestStream(_models_stream__WEBPACK_IMPORTED_MODULE_8__["StreamOptions"].Audio);

                  case 2:
                    this.localStream = _context3.sent;
        ...
        value: function enableVideo() {
          return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
            var videoStream, videoTrack, streamId;
            return regeneratorRuntime.wrap(function _callee4$(_context4) {
              while (1) {
                switch (_context4.prev = _context4.next) {
                  case 0:
                    _context4.next = 2;
                    return this.requestStream(_models_stream__WEBPACK_IMPORTED_MODULE_8__["StreamOptions"].Video);

                  case 2:
                    videoStream = _context4.sent;
                    this.localStreamSubject.next(videoStream);
                    videoTrack = videoStream.getVideoTracks()[0];
                    streamId = this.user.userId + "_video";
        ...
        key: "disableScreen",
        value: function disableScreen() {
          var streamId = this.user.userId + "_screen";
              ...
              while (1) {
                switch (_context5.prev = _context5.next) {
                  ...
                  case 2:
                    ...
                    videoTrack = videoStream.getVideoTracks()[0];
                    streamId = this.user.userId + "_screen";
                    this.peer[streamId] = new _helper_PeerConnection__WEBPACK_IMPORTED_MODULE_7__["PeerConnection"](streamId, videoTrack, videoStream, this.dataChannerSender.bind(this), null);
                    this.peer[streamId].initialize();
            ...
            return regeneratorRuntime.wrap(function _callee6$(_context6) {
              while (1) {
                switch (_context6.prev = _context6.next) {
                  ...
                  case 2:
                    this.localStream = _context6.sent;
                    this.ongoingCall.status = _models_call__WEBPACK_IMPORTED_MODULE_6__["CallStatus"].InCall;
        ...
        key: "onCandidate",
        value: function onCandidate(message) {
          var candidate = new RTCIceCandidate({
        ...
        key: "onOffer",
        value: function onOffer(message) {
        ...
        key: "hendleAnswer",
        value: function hendleAnswer(data) {
          this.pc.setRemoteDescription(new RTCSessionDescription(data));
        }
      }, {
        ...
        key: "setLocalAndSendOffer",
        value: function setLocalAndSendOffer(sessionDescription) {
          this.pc.setLocalDescription(sessionDescription);
        ...
        key: "requestStream",
        value: function requestStream(op) {
          var _this27 = this;

          return new Promise(function (resolve, reject) {
            var audio = false;
            var video = false;
            if (op == _models_stream__WEBPACK_IMPORTED_MODULE_8__["StreamOptions"].Audio) audio = true;
            if (op == _models_stream__WEBPACK_IMPORTED_MODULE_8__["StreamOptions"].Video) video = true;
            window["navigator"].mediaDevices.getUserMedia({
              audio: audio,
              video: video
            }).then(function (stream) {
              _this27.addLog("Adding local stream.");
        ...
        key: "requestScreen",
        value: function requestScreen() {
          return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee7() {
            var captureStream, displayMediaStreamConstraints;
            return regeneratorRuntime.wrap(function _callee7$(_context7) {
              while (1) {
                switch (_context7.prev = _context7.next) {
                  ...
                  case 17:
                    return _context7.abrupt("return", captureStream);
        ...
        key: "addLog",
        value: function addLog() {//console.log(...arg);
        }
      }, {
        key: "createPeerConnection",
        value: function createPeerConnection() {
          var createDC = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
        ...
        key: "onDataChannel",
        value: function onDataChannel(event) {
        ...
        key: "handlePeerConnectionStateChange",
        value: function handlePeerConnectionStateChange(event) {
          switch (this.pc.connectionState) {
            case "connected":
              // The connection has become fully connected
              break;
        ...
        key: "callDesconnected",
        value: function callDesconnected() {
          this.remoteStreamSubject.next({});
          this.ongoingCall.status = _models_call__WEBPACK_IMPORTED_MODULE_6__["CallStatus"].Idle; //alert("failed 2");
        }
      }, {
        ...
        key: "attachEventsToDataChannel",
        value: function attachEventsToDataChannel() {
          var _this28 = this,
          ...
          this.dataChannel.onerror = function (error) {
            _this28.addLog("Data Channel Error:", error);
          };
          ...
          this.dataChannel.addEventListener("message", function (event) {
            ...
            if (signal.type == "dc") {
              ...
              if (!_this28.peer[data.id]) {
                _this28.peer[data.id] = new _helper_PeerConnection__WEBPACK_IMPORTED_MODULE_7__["PeerConnection"](data.id, null, null, _this28.dataChannerSender.bind(_this28), _this28.processPeerStream.bind(_this28));
              }

              _this28.peer[data.id].processSignal(data);
            } else if (signal.type == "close") {
              _this28.closePeerConnection(signal);
            } else if (signal.type == "disconnect") {
              _this28.closeAllConnections();
            }

            _this28.addLog("Got Data Channel Message:", event.data);
          });

          this.dataChannel.onopen = function () {
            _this28.addLog(_arguments);
          };

          this.dataChannel.onclose = function () {
            _this28.addLog("The Data Channel is Closed");
          };
        }
      }, {
        key: "processPeerStream",
        value: function processPeerStream(id, stream) {
        ...
        value: function closePeerConnection(data) {
        ...
        key: "dataChannerSender",
        value: function dataChannerSender(data) {
          var signal = {
            type: "dc",
        ...
        key: "sendSignalOverDataChannel",
        value: function sendSignalOverDataChannel(signal) {
    ...
    CallService.ɵfac = function CallService_Factory(t) {
      return new (t || CallService)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_socket_service__WEBPACK_IMPORTED_MODULE_2__["SocketService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_user_service__WEBPACK_IMPORTED_MODULE_9__["UserService"]));
    };

    CallService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"]({
      token: CallService,
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](CallService, [{
  ...
  function srcAppServicesChatServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ChatService = /*#__PURE__*/function () {
      function ChatService(apiService, socketService, userService, notificationService) {
        var _this29 = this;
        ...
        this.socketService.event("message").subscribe(function (_signal) {
          var signal = JSON.parse(_signal);

          if (signal.type == _models_signal__WEBPACK_IMPORTED_MODULE_4__["SignalType"].message) {
            var msg = signal.data;

            if (msg) {
              var message = _this29.formatMessage(msg.message, msg.type, msg.from, msg.to);

              _this29.pushMessage(message, true);

              if (msg.from !== _this29._activeUser.userId) {
                _this29.trigerNotification(msg);
              }
            }
          }
        });
      ...
      _createClass(ChatService, [{
        key: "trigerNotification",
        value: function trigerNotification(msg) {
          var user = this.userService.getUserByUserId(msg.from);
        ...
        value: function createGroup(data) {
          ...
          return rxjs__WEBPACK_IMPORTED_MODULE_2__["Observable"].create(function (ob) {
            _this30.apiService.post("/group/create", data).subscribe(function (res) {
              ob.next(res.success);
            });
          });
        }
        ...
        value: function updateSearchQuery(query) {
          this.searchSubject.next(query);
        }
      }, {
        key: "getUrlMetadata",
        value: function getUrlMetadata(url) {
          var _this31 = this;

          return rxjs__WEBPACK_IMPORTED_MODULE_2__["Observable"].create(function (ob) {
            if (_this31._metadata[url]) {
              ob.next(_this31._metadata[url]);
            } else {
              _this31.apiService.post("/metadata/get", {
                url: url
              }).subscribe(function (res) {
                _this31._metadata[url] = res;
                ob.next(res);
              });
            }
          });
        ...
        value: function setActiveUser(user) {
          ...
          if (!this.messages.users[this._activeUser.userId]) {
            ...
            this.apiService.post("/chat/messages", {
              isGroup: false,
              id: this._activeUser.userId
            }).subscribe(function (response) {
              if (response.success) {
                _this32.messages.users[_this32._activeUser.userId].fetchStatus = true;
                response.data.messages.forEach(function (msg) {
                  _this32.messages.users[_this32._activeUser.userId].chat.push(_this32.formatMessage(msg.message, msg.messageType, msg.senderId, msg.receiverId, new Date(msg.sendDate)));
                });
              }

              _this32.refreshChatWindow();
            });
        ...
        key: "sendMessage",
        value: function sendMessage(text, type) {
          var message = this.formatMessage(text, type);
          var signal = new _models_signal__WEBPACK_IMPORTED_MODULE_4__["OutgoingSignal"]();
        ...
        key: "formatMessage",
        value: function formatMessage(text, type) {
          var from = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : this.user.userId;
          var to = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : this._activeUser.userId;
        ...
        key: "refreshChatWindow",
        value: function refreshChatWindow() {
          if (!this.messages.users[this._activeUser.userId]) this.initializeChat(this._activeUser.userId, false);
          this.activeMessages.next(this.messages.users[this._activeUser.userId].chat);
        }
      }, {
        key: "initializeChat",
        value: function initializeChat(id, isGroup) {
        ...
        value: function uploadFile(file) {
          ...
          return rxjs__WEBPACK_IMPORTED_MODULE_2__["Observable"].create(function (ob) {
            ...
            _this33.apiService.post("/file/upload", formData).subscribe(function (res) {
  ...
  function srcAppServicesNotificationServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var NotificationService = /*#__PURE__*/function () {
      ...
      _createClass(NotificationService, [{
        ...
        key: "failure",
        value: function failure(title, message) {
          this.triggerNotification("error", title, message);
        }
      }, {
        key: "triggerNotification",
        value: function triggerNotification(type, title, message) {
          window["$"].ambiance({
            message: message,
            title: title,
            type: type
    ...
    var SocketService = /*#__PURE__*/function () {
      ...
      _createClass(SocketService, [{
        ...
        value: function event(_event) {
          return this.socket.fromEvent(_event);
        }
      }, {
        key: "sendSignal",
        value: function sendSignal(data) {
          var event = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "message";
          var signal = JSON.stringify(data);
  ...
  function srcAppServicesUserServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _models_message__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ../models/message */
    "./src/app/models/message.ts");

    var UserService = /*#__PURE__*/function () {
      function UserService(apiService, router, socketService) {
        var _this34 = this;
        ...
        this.users = [];
        this.socketService.event("statusupdate").subscribe(function (update) {
          var data = JSON.parse(update);

          _this34.users.map(function (user) {
          ...
          _this34.activeUsers.next(_this34.users);
        });
      }
      ...
      _createClass(UserService, [{
        ...
        value: function viewProfile(id) {
          console.log(this.users.filter(function (u) {
            return u.userId == id;
          }));
          this.openProfile.next(this.users.filter(function (u) {
            return u.userId == id;
          })[0]);
        }
      }, {
        ...
        value: function setUser(user) {
          if (!user.profileImagePath) {
            user.profileImagePath = "https://ui-avatars.com/api/?name=".concat(user.firstName, "+").concat(user.lastName, "&background=0D8ABC&color=fff&rounded=true&size=150");
          } else {
          ...
          document.title = "".concat(user.firstName, " ").concat(user.lastName, " - ChatApp");
          this.getAllUsers();
        }
      }, {
        key: "populateUser",
        value: function populateUser() {
          var _this35 = this;

          this.apiService.get("/user/profile").subscribe(function (res) {
            if (res.success) {
              if (!res.data.user.profileImagePath) {
                res.data.user.profileImagePath = "https://ui-avatars.com/api/?name=".concat(res.data.user.firstName, "+").concat(res.data.user.lastName, "&background=0D8ABC&color=fff&rounded=true&size=150");
              } else {
                res.data.user.profileImagePath = src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].SERVER_URL + res.data.user.profileImagePath;
              }

              _this35._user = res.data.user;

              _this35.userSubject.next(_this35._user);
            } else {
        ...
        value: function getActiveUsers() {
          ...
          return rxjs__WEBPACK_IMPORTED_MODULE_1__["Observable"].create(function (o) {
            _this36.apiService.get("/user/active-users").subscribe(function (res) {
              if (res.success) o.next(_this36.processUsers(res.data.users));else o.next([]);
            });
          });
        }
      }, {
        key: "getUserByUserId",
        value: function getUserByUserId(id) {
        ...
        value: function getAllUsers() {
          ...
          this.apiService.get("/user/active-users").subscribe(function (res) {
            if (res.success) {
              _this37.users = _this37.processUsers(res.data.users);

              _this37.activeUsers.next(_this37.users);
            }
          });
        }
      }, {
        key: "updateLastMessage",
        value: function updateLastMessage(message, activeUserId) {
          var content = message.content;

          for (var index = 0; index < this.users.length; index++) {
            if (this.users[index].userId === message.from || this.users[index].userId === message.to) {
              if (message.type === _models_message__WEBPACK_IMPORTED_MODULE_6__["MessageType"].Image || message.type === _models_message__WEBPACK_IMPORTED_MODULE_6__["MessageType"].Video || message.type === _models_message__WEBPACK_IMPORTED_MODULE_6__["MessageType"].File) {
              ...
              if (!(message.from === activeUserId || message.to === activeUserId)) this.users[index].unreadCount += 1;
            }
          }
        }
      }, {
        key: "resetUnreadCount",
        value: function resetUnreadCount(id) {
          for (var index = 0; index < this.users.length; index++) {
        ...
        value: function updateUserProfile(data) {
          ...
          return rxjs__WEBPACK_IMPORTED_MODULE_1__["Observable"].create(function (ob) {
            var formData = new FormData();
            if (image) formData.append("file", image, image.name);
            formData.append("data", JSON.stringify(data));

            _this38.apiService.post("/user/update-profile", formData).subscribe(function (res) {
              if (res.success) _this38.populateUser();
              ob.next(res.success);
            }, function (err) {
              ob.next(false);
            });
        ...
        key: "processUsers",
        value: function processUsers(users) {
          var _this39 = this;

          users.forEach(function (user) {
            return _this39.processUser(user);
          });
          return users;
        }
      }, {
        ...
        value: function processUser(user) {
          if (user.profileImagePath && user.profileImagePath.indexOf("https://ui-avatars.com") === -1) {
            user.profileImagePath = "".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].SERVER_URL).concat(user.profileImagePath);
          } else user.profileImagePath = "https://ui-avatars.com/api/?name=".concat(user.firstName, "+").concat(user.lastName, "&background=0D8ABC&color=fff&rounded=true&size=150");
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! D:\Work\Code\Chat-App-GM\chat-app-server\client\src\main.ts */
    "./src/main.ts");
    /***/
  },
